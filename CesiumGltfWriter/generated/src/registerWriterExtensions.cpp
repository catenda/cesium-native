...
context.registerExtension<CesiumGltf::Model, EXT_structural_metadataGlTFDocumentExtensionJsonWriter>();
context.registerExtension<CesiumGltf::Model, ExtensionModelKhrMaterialsVariantsJsonWriter>();
context.registerExtension<CesiumGltf::Model, ExtensionModelMaxarMeshVariantsJsonWriter>();
context.registerExtension<CesiumGltf::Model, ExtensionModelCatendaMetadataJsonWriter>();
context.registerExtension<CesiumGltf::MeshPrimitive, ExtensionCesiumTileEdgesJsonWriter>();
context.registerExtension<CesiumGltf::MeshPrimitive, ExtensionExtMeshFeaturesJsonWriter>();
context.registerExtension<CesiumGltf::MeshPrimitive, ExtensionMeshPrimitiveExtStructuralMetadataJsonWriter>();
...
context.registerExtension<CesiumGltf::Node, ExtensionNodeMaxarMeshVariantsJsonWriter>();
context.registerExtension<CesiumGltf::Buffer, ExtensionBufferExtMeshoptCompressionJsonWriter>();
context.registerExtension<CesiumGltf::BufferView, ExtensionBufferViewExtMeshoptCompressionJsonWriter>();
context.registerExtension<CesiumGltf::Material, ExtensionKhrMaterialsUnlitJsonWriter>();
context.registerExtension<CesiumGltf::Texture, ExtensionKhrTextureBasisuJsonWriter>();
context.registerExtension<CesiumGltf::Texture, ExtensionTextureWebpJsonWriter>();
context.registerExtension<CesiumGltf::TextureInfo, ExtensionKhrTextureTransformJsonWriter>();
context.registerExtension<CesiumGltf::MaterialOcclusionTextureInfo, ExtensionKhrTextureTransformJsonWriter>();
