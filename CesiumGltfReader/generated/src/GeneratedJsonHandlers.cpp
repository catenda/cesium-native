...
void ExtensionModelCatendaMetadataJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
    CesiumGltf::ExtensionModelCatendaMetadata* pObject) {
  CesiumJsonReader::ExtensibleObjectJsonHandler::reset(pParentHandler, pObject);
  this->_pObject = pObject;
}

CesiumJsonReader::IJsonHandler*
ExtensionModelCatendaMetadataJsonHandler::readObjectKey(
    const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyExtensionModelCatendaMetadata(
      CesiumGltf::ExtensionModelCatendaMetadata::TypeName,
      str,
      *this->_pObject);
}
...
void ExtensionModelCatendaMetadataJsonHandler::reset(
  ...
  std::any& value =
      o.extensions
          .emplace(extensionName, CesiumGltf::ExtensionModelCatendaMetadata())
          .first->second;
  this->reset(
      pParentHandler,
...
CesiumJsonReader::IJsonHandler* ExtensionModelCatendaMetadataJsonHandler::
    readObjectKeyExtensionModelCatendaMetadata(
        const std::string& objectType,
        const std::string_view& str,
        CesiumGltf::ExtensionModelCatendaMetadata& o) {
  using namespace std::string_literals;

  if ("objects"s == str)
    return property("objects", this->_objects, o.objects);
...
CesiumJsonReader::IJsonHandler*
ExtensionCatendaMetadataObjectMetadataJsonHandler::readObjectKey(
    const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyExtensionCatendaMetadataObjectMetadata(
      CesiumGltf::ExtensionCatendaMetadataObjectMetadata::TypeName,
      str,
      *this->_pObject);
}
...
CesiumJsonReader::IJsonHandler*
ExtensionCatendaMetadataObjectMetadataJsonHandler::
    readObjectKeyExtensionCatendaMetadataObjectMetadata(
        const std::string& objectType,
        const std::string_view& str,
...
void ExtensionCatendaMetadataObjectMetadataAttributeJsonHandler::reset(
    CesiumJsonReader::IJsonHandler* pParentHandler,
...
CesiumJsonReader::IJsonHandler*
ExtensionCatendaMetadataObjectMetadataAttributeJsonHandler::readObjectKey(
    const std::string_view& str) {
  assert(this->_pObject);
  return this->readObjectKeyExtensionCatendaMetadataObjectMetadataAttribute(
      CesiumGltf::ExtensionCatendaMetadataObjectMetadataAttribute::TypeName,
      str,
      *this->_pObject);
}
...
CesiumJsonReader::IJsonHandler*
ExtensionCatendaMetadataObjectMetadataAttributeJsonHandler::
    readObjectKeyExtensionCatendaMetadataObjectMetadataAttribute(
        const std::string& objectType,
        const std::string_view& str,
